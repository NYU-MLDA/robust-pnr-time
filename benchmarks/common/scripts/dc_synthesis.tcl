...
report_timing -start_end_pair -max_paths 1500000 -input_pins -nets -nosplit -transition_time > ${REPORTS_DIR}/timing_report.rpt
report_reference -nosplit -hier > ${REPORTS_DIR}/reference.rpt

#- add
change_names -rules verilog -hier
# Writing out synthesized design
#saif_map -type ptpx -write_map ${RESULTS_DIR}/${TOP_DESIGN}_post_synth.namemap
