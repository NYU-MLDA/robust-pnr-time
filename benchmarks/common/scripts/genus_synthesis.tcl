...
check_design
syn_gen
report_timing -max_paths 150000 -nworst 3 > ${RESULTS_DIR}/${TOP_DESIGN}_generic_timing.rpt
...
syn_map
syn_opt
report_timing -max_paths 150000 -nworst 3 > ${RESULTS_DIR}/${TOP_DESIGN}_techmap_timing.rpt
ungroup -flatten -all
