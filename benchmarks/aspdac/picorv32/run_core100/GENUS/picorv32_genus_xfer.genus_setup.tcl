...
if {$_slk_ != "-329.5"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: -329.5,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_tns_ != "444617"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden tns: 444617,  current tns: $_tns_"
}
unset _tns_
# cell area
...
if {$_cell_area_ != "18325"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 18325,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "15757"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 15757,  current net area: $_net_area_"
}
unset _net_area_
