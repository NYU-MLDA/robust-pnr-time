...
if {$_slk_ != "-201.8"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: -201.8,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_tns_ != "189725"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden tns: 189725,  current tns: $_tns_"
}
unset _tns_
# cell area
...
if {$_cell_area_ != "18227"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 18227,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "15590"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 15590,  current net area: $_net_area_"
}
unset _net_area_
