...
# Generated on: Sat Feb 27 20:01:43 EST 2021 (Sun Feb 28 01:01:43 GMT 2021)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/gcd/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/gcd -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/opt/cadence/installs/GENUS181/tools.lnx86"
set CDN_SYNTH_ROOT      "/opt/cadence/installs/GENUS181/tools.lnx86"
set env(CW_DIR) "/opt/cadence/installs/GENUS181/tools.lnx86/lib/chipware"
set CW_DIR      "/opt/cadence/installs/GENUS181/tools.lnx86/lib/chipware"

# default is to error out when module definitions are missing
set_undefined_cell black_box -noascend -both

add_search_path . /opt/cadence/installs/GENUS181/tools.lnx86/lib/tech * -library -both
read_library -liberty -both   /home/abc586/freepdk-45nm/stdcells.lib
...
read_design     -merge bbox -golden -lastmod -noelab -verilog2k -f file_list.f
elaborate_design -golden -root {gcd} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/gcd/fv_map.v.gz
elaborate_design -revised -root {gcd}
...
#add_name_alias fv/gcd/fv_map.singlebit.original_name.alias.json.gz -revised
